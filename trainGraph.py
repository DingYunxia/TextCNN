...
embedding_dim = 20        #  embedding层的维度为20维
filter_sizes = (3, 4)     #  卷积窗口的大小为3或者4
num_filters = 3           #  卷积3次
dropout_prob = (0.7, 0.8) #  dropout的大小为0.7或者0.8
hidden_dims = 100        # 隐藏层的维度为100为
...
** Another distinct difference is slidind(changed) MaxPooling window of length=2
...
# Load data
print("Loading data...")
x, y, vocabulary, vocabulary_inv = data_helpers.load_data() #将数据加载进来，调用data_hapers.py中的load_data函数
# 模型选择
